...
export default function OmikujiShakePageTheatre() {
  ...
  useEffect(() => {
    ...
    const redirectTimer = setTimeout(() => {
      router.push('/omikuji-theatre/result?fortune=大吉');
    }, 3500);
      ...
      */}
      ...
      <div className="absolute top-0 left-0 right-0 bg-[#1B365D]/80 z-50 flex items-center justify-between px-4 py-2">
        ...
        <h2 className="text-white font-bold text-sm md:text-base">
          EDO ICHIBA OMIKUJI (Theatre.js + Leva)
        </h2>
        <div className="w-16" />
      </div>
      ...
      {/* 3Dおみくじ箱と小判、花火（Theatre.js + Leva統合） */}
