...
function OmikujiResultContentTheatre() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-[#1B365D] via-[#0f2740] to-black">
      ...
      >
        <motion.button
          onClick={() => router.push('/omikuji-theatre')}
