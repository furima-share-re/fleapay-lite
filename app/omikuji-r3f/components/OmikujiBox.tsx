...
export default function OmikujiBox({ isShaking = false, position = [0, 0, 0] }: OmikujiBoxProps) {
  ...
  return (
    <group ref={boxRef} position={position}>
      ...
      {/* 光る効果 */}
      <pointLight position={[0, 0, 2]} intensity={isShaking ? 2 : 1} color="#fbbf24" distance={5} />
    </group>
  );
}
