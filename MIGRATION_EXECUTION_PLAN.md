...
**プロジェクト**: fleapay-lite  
**作成日**: 2025-01-15  
**最終更新**: 2026-01-02（Phase 2.2実装完了、/api/seller/summary API Route Handler移行完了、TypeScript型エラー修正完了、動作確認完了、ルール準拠確認完了）  
...
|-------|----------|---------|------|------|
| **Phase 2.3** | Next.js画面移行（続き） | 2026-01-02 | ⏳ **進行中** | **最優先**（セラー登録画面移行完了、決済画面・チェックアウト画面・管理画面移行中） |
