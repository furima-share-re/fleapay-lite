...
**プロジェクト**: fleapay-lite  
**作成日**: 2025-01-15  
**最終更新**: 2026-01-02（Phase 2.3実装完了、全画面実装完了、API Route Handler 13個、Next.js Pages 14個、TypeScript型エラーなし、Linterエラーなし、ルール準拠確認完了、デグレチェック完了）  
...
|-------|----------|---------|------|------|
| **Phase 2.4** | Next.js残りAPI・画面移行 | 2026-01-02 | ⏳ **未着手** | **最優先**（残りのAPIエンドポイント13個、画面5個の移行） |
